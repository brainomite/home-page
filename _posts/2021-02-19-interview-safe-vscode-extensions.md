...
The videos are demos/brief descriptions, on average 1.5 minutes long
{:.note}
...
Do you want to track how much coding you are doing? Here are two options.
I actually use both simultaneously
...
[Code Time](https://marketplace.visualstudio.com/items?itemName=softwaredotcom.swdc-vscode) and its
complimentary [web service](https://www.software.com/code-time), that will let
you know exactly this and more!
